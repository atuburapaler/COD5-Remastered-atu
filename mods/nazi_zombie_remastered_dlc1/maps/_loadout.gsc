...
//		set_switch_weapon( "m2_flamethrower_wet" );
	...
	else if( GetDvar( "zombiemode" ) == "1" || IsSubStr( level.script, "nazi_zombie_" ) ) // CODER_MOD (Austin 5/4/08): zombiemode loadout setup
	{
		...
		PrecacheModel( "viewmodel_usa_raider_sleeved_arms" );
		PrecacheModel( "viewmodel_usa_raider_sleeved_player" );

		set_player_viewmodel( "viewmodel_usa_raider_sleeved_arms");
		set_player_interactive_hands( "viewmodel_usa_raider_sleeved_player");
